...
rho = 0.02;% tune this parameter to controal the estimated rank N
[rankN,~] = prox_rankN(X,rho);%n*ones(1,n3);%
[Xhat3,~,~,~] =  lrtc_tnn_pssv(M,omega,opts,rankN);%,Xhat2);%
...
% %% Tensor completion based on Framele_t_tsvd
%
